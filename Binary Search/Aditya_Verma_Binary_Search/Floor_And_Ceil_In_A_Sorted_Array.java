...
class Solution {
    ...
    // for eg - {1,2,4,5} x = 3
    // We are trying to find 3 and we are not able to find it so our low will be at
    // index 1
    // and high will be at index 2
    // and the missing 3 should have been between this low and high and our low will
    // be
    // pointing at the floor(the value just less than X) and high will be pointing
    // at Ceil

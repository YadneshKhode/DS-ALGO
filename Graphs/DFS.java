...
/*
// this will start traversal from 0 node and visit nodes that are reachable only from 0th node
...
*/
    ...
    public void dfs(int V, ArrayList<ArrayList<Integer>> adj, ArrayList<Integer> res, boolean[] vis, ArrayDeque<Integer> deque){
